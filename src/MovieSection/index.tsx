...
const movies: Movie[] = [
  ...
  {
    id: 2,
    src: "./public/amigo_da_sombra.png",
  ...
  {
    id: 3,
    src: "./public/amigos_do_bosque_magico.png",
  ...
  {
    id: 4,
    src: "./public/caminho_para_o_abismo.png",
  ...
  {
    id: 5,
    src: "./public/desastres_do_escritorio.png",
  ...
  {
    id: 6,
    src: "./public/mestres_do_futuro.png",
  ...
  {
    id: 8,
    src: "./public/o_nexus_do_tempo.png",
    ...
    <main>
      <section className={styles.container}>
        <Fieldset variant="secondary">
          <InpuText placeholder="Buscar filmes..." />
          <Button variant="icon">
            <FaSearch />
          </Button>
        </Fieldset>
